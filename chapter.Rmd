...
pop %>%
  dplyr::select(fem_p_16   ,netmig_r_16, gdp_eurhab_16, loun_p_act_16, unra1524_16,
         unraall_16, hcide_r_10 , robb_r_10    , burg_r_10 , vthft_r_10   , he_p_16,
         medage_16) %>%
...
fun_imput <- aregImpute(~ fem_p_16 + netmig_r_16 + gdp_eurhab_16 + he_p_16 + loun_p_act_16 + popdens_16 +
                  unraall_16 + hcide_r_10 +robb_r_10 + burg_r_10 + vthft_r_10 + unra1524_16 +
                  medage_16, 
...
imputed <- as.data.frame(impute.transcan(fun_imput, imputation=1, rhsImp="mean", data = pop, list.out=T))
...
model <- lm(Direct ~  fem_p_16 + gdp_eurhab_16 + loun_p_act_16 + hcide_r_10+
              robb_r_10 + burg_r_10 + vthft_r_10 + medage_16 + he_p_16, data = pop2 )



model <- lm(Direct ~  fem_p_16 + gdp_eurhab_16 +
              robb_r_10 + burg_r_10 +  medage_16 + he_p_16, data = pop2 )
