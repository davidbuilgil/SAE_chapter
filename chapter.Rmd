...
Once we have produced our direct estimates of trust in the police, we can see how these look like by using the `summary()` function introduced before.
