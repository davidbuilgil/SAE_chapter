...
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{trstplc =} \KeywordTok{as.numeric}\NormalTok{(trstplc)) }\CommentTok{# transform variable to numeric}

\KeywordTok{summary}\NormalTok{(ess}\OperatorTok{$}\NormalTok{trstplc) }\CommentTok{# print summary statistics}
\end{Highlighting}
\end{Shaded}
